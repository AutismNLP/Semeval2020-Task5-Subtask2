...
def build_dataset_for_bert(raw_dataset, token_to_id, tag_pad_idx=tokenizer.encoder['<pad>'], total_length=None, device='cpu'):
...
def build_dataset_for_bert_crf(raw_dataset, token_to_id, total_length=None, device='cpu'):
    ...
    for sample in raw_dataset:
        ...
        num_tags = NUM_TAGS + 2     # add START and END (5+2)
